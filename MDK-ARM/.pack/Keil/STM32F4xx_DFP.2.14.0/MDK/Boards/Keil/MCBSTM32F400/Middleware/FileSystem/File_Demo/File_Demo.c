...
static void init_display () {
  ...
  GLCD_DrawString         (0U*16U, 0U*24U, "    MCBSTM32F400    ");
  GLCD_DrawString         (0U*16U, 1U*24U, "  Evaluation Board  ");
  GLCD_DrawString         (0U*16U, 3U*24U, "      MDK-ARM       ");
  GLCD_DrawString         (0U*16U, 4U*24U, " File_Demo example  ");
}
