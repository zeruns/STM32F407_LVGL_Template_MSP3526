...
#define ARM_USBH_DRV_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(2,22)
...
//                   USB_OTG_HCINTMSK_ACKM    | // After ACK there must be other relevant interrupt so ACK is ignorred
                     USB_OTG_HCINTMSK_NAKM    |
                     USB_OTG_HCINTMSK_STALLM  |
                     USB_OTG_HCINTMSK_XFRCM)  ;
        out       =  1U;
